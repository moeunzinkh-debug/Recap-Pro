...
- **Workers Free plan**: CPU 10 ms/request — សម្រាប់វីដេអូធំៗ (frames ច្រើន) អាចមិនគ្រប់។ ប្រើ **Workers Paid ($5/ខែ)** នឹងមាន CPU 30s (config នេះបានកំណត់ `limits.cpu_ms = 300000` រួចហើយ)។
